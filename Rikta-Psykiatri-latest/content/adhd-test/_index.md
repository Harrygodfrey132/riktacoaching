    ...
    <div class="adhd-screening__shell">
      ...
      <form class="adhd-screening__card" id="adhd-screening-form">
        <div class="adhd-screening__summary">
          ...
          <dl class="adhd-meta">
            ...
            <div class="adhd-meta__row">
              ...
              <dd class="adhd-meta__value">Tidig screening. Resultaten visar risknivå och vägleder nästa steg men ersätter inte en diagnostisk utredning.</dd>
            </div>
            <div class="adhd-meta__row">
              <dt class="adhd-meta__label">Tidsram</dt>
              <dd class="adhd-meta__value">Utgå från beteenden som observerats under de senaste sex månaderna.</dd>
            </div>
            <div class="adhd-meta__row">
              <dt class="adhd-meta__label">Skala</dt>
              <dd class="adhd-meta__value">0 = Aldrig, 1 = Sällan, 2 = Ibland, 3 = Ofta / Mycket ofta.</dd>
            </div>
          </dl>
        </div>
          ...
          <ol class="adhd-question-list">
            <li class="adhd-question">
              ...
              <div class="adhd-response-group">
                ...
                <label class="adhd-response">
                  <input type="radio" name="q1" value="3" data-merged>
            ...
            <li class="adhd-question">
              ...
              <div class="adhd-response-group">
                ...
                <label class="adhd-response">
                  <input type="radio" name="q2" value="3" data-merged>
                  <span>Mycket ofta</span>
                </label>
              </div>
            </li>
            <li class="adhd-question">
              ...
              <div class="adhd-response-group">
                ...
                <label class="adhd-response">
                  <input type="radio" name="q3" value="3" data-merged>
                  <span>Mycket ofta</span>
                </label>
              </div>
            </li>
            <li class="adhd-question">
              ...
              <div class="adhd-response-group">
                ...
                <label class="adhd-response">
                  <input type="radio" name="q4" value="3" data-merged>
                  <span>Mycket ofta</span>
                </label>
              </div>
            </li>
            <li class="adhd-question">
              ...
              <div class="adhd-response-group">
                ...
                <label class="adhd-response">
                  <input type="radio" name="q5" value="3" data-merged>
                  <span>Mycket ofta</span>
                </label>
              </div>
            </li>
            <li class="adhd-question">
              ...
              <div class="adhd-response-group">
                ...
                <label class="adhd-response">
                  <input type="radio" name="q6" value="3" data-merged>
                  <span>Mycket ofta</span>
                </label>
              </div>
            </li>
        ...
        <div aria-live="polite" class="adhd-score" id="adhd-score" hidden>
          ...
          <p class="adhd-score__note">Denna screening ställer ingen diagnos. Kontakta Rikta Psykiatri för en klinisk bedömning, behandlingsplanering eller coachande stöd.</p>
        </div>
      </form>
    </div>
  </div>
