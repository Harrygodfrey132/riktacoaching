...
og_description: "Korta screeningtester för ADHD och autism – vägledning, inte diagnos."
...
<section class="tests-hero" id="top">
  <div class="container tests-hero__grid">
    <div class="tests-hero__copy">
      ...
      <h1>Tester</h1>
      <p class="lead">Välj ett kort screeningtest för att utforska ADHD eller autism. Tester ersätter inte en klinisk bedömning, men kan hjälpa dig ta nästa steg.</p>
      ...
      <p class="tests-hero__note small muted">Tester är vägledande och ersätter inte en klinisk utredning.</p>
    </div>
    <div class="tests-hero__panel">
      <div class="tests-hero__panel-card">
        ...
        <ul class="tests-hero__list">
          ...
          <li>Omedelbar poäng och vägledning</li>
  ...
  <div class="container">
    ...
    <div class="tests-cards">
      ...
      <article class="tests-card tests-card--rose">
        ...
        <p>Ett kort, validerat screeningtest för vuxna som vill utforska autistiska drag.</p>
        <ul class="tests-card__list">
