    ...
    <div class="who-grid intro-grid">
      ...
      <div class="intro-stats adhd-definition-card">
        ...
        <ul>
          ...
          <li>Strategier för att hantera känslor, motivation och autopilotbeteenden.</li>
  ...
  <div class="container">
    ...
    <div class="adhd-process-grid">
      <article class="adhd-process-card">
        ...
        <ul>
          <li>Tydlig målformulering och nulägesanalys.</li>
          <li>Val av fokusområden för första coachcykeln.</li>
        </ul>
      </article>
      <article class="adhd-process-card">
        <div class="adhd-step">
          ...
          <div>
            <h3>Strategidesign</h3>
            <p>Vi testar verktyg för planering, tidsstyrning och känslohantering som matchar din vardag.</p>
          </div>
        </div>
        <ul>
      ...
      <article class="adhd-process-card">
        <div class="adhd-step">
          ...
          <div>
            <h3>Integrering &amp; nästa mål</h3>
            <p>Vi sammanfattar lärdomar, dokumenterar verktygslådan och bestämmer nästa utvecklingssteg.</p>
          </div>
        </div>
        <ul>
...
<section class="adhd-final-cta" id="boka">
  <div class="container">
    ...
    <a class="btn primary" href="/kontakta-oss">Boka ett introduktionssamtal</a>
    <p class="muted">Vill du bli uppringd? Mejla oss så hittar vi en tid som passar.</p>
  </div>
</section>
