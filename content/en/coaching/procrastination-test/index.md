          ...
          <ol class="adhd-question-list">
            ...
            <li class="adhd-question">
              ...
              <div class="adhd-response-group">
                ...
                <label class="adhd-response"><input type="radio" name="q13" value="3"><span>3</span></label>
                <label class="adhd-response"><input type="radio" name="q13" value="4"><span>4</span></label>
                <label class="adhd-response"><input type="radio" name="q13" value="5"><span>5</span></label>
              </div>
            </li>
            <li class="adhd-question">
              ...
              <div class="adhd-response-group">
                ...
                <label class="adhd-response"><input type="radio" name="q14" value="3"><span>3</span></label>
                <label class="adhd-response"><input type="radio" name="q14" value="4"><span>4</span></label>
                <label class="adhd-response"><input type="radio" name="q14" value="5"><span>5</span></label>
              </div>
            </li>
            <li class="adhd-question">
              ...
              <div class="adhd-response-group">
                ...
                <label class="adhd-response"><input type="radio" name="q15" value="3"><span>3</span></label>
                <label class="adhd-response"><input type="radio" name="q15" value="4"><span>4</span></label>
                <label class="adhd-response"><input type="radio" name="q15" value="5"><span>5</span></label>
              </div>
            </li>
          </ol>
        </fieldset>
