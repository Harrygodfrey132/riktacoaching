  ...
  <div class="coachning-panel">
    ...
    <div class="coachning-format-grid">
      <article class="coachning-format">
        <h4>Personliga mål</h4>
        <p>Du och din coach prioriterar fokusområden utifrån vardag, arbete, relationer eller studier.</p>
      </article>
      <article class="coachning-format">
        <h4>Tvärprofessionellt stöd</h4>
        <p>Behövs insatser från läkare eller psykolog tar vi in rätt kompetens från vårt specialistteam.</p>
      </article>
      <article class="coachning-format">
...
<section class="coachning-section" id="program">
  <div class="coachning-panel">
    <h2>Våra program</h2>
