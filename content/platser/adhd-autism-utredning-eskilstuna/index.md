---
title: "ADHD- och autismutredning i Eskilstuna"
draft: false
meta_title: "ADHD- och autismutredning i Eskilstuna | Rikta"
meta_keywords: "ADHD utredning Eskilstuna, autism privat Eskilstuna, psykiater Eskilstuna, neuropsykiatri Sörmland, Rikta Eskilstuna"
meta_description: "Digitala ADHD- och autismutredningar för Eskilstuna med specialistteam, videobesök och korta fysiska pass när det behövs."
og_title: "Neuropsykiatrisk utredning i Eskilstuna"
og_description: "Komplett ADHD- och autismutredning med digitalt upplägg och punktinsatser nära Eskilstuna."
---

<section class="location-hero location-hero--eskilstuna">
  <div class="container">
    <div class="location-hero__grid">
      <div class="location-hero__copy">
        <span class="eyebrow">Eskilstuna • Digitalt upplägg</span>
        <h1>ADHD- och autismutredning i Eskilstuna</h1>
        <p class="lead">
          Vi hjälper dig i Eskilstuna och Sörmland att få en strukturerad utredning som fungerar med ditt arbetsliv, studier eller familjesituation.
          Kartläggning, psykologintervjuer, tester och läkarbesök sker via video. Om ett enskilt moment kräver fysisk närvaro planerar vi ett kort besök i Stockholm.
        </p>
        <ul class="location-hero__highlights">
          ...
          <li>Intyg och underlag anpassade för Eskilstunas arbetsgivare, kommunala skolor och CSN.</li>
...
<section class="location-journey">
  <div class="container">
    <header class="location-section__header">
      ...
      <p>Upplägget anpassas för dig som bor i Eskilstuna, arbetar i näringslivet, pendlar mot Stockholm eller balanserar familjeliv med karriär.
    ...
    <div class="location-journey__steps">
      ...
      <article class="location-step">
        ...
        <p>Neuropsykologiska tester och läkarbedömning görs i första hand via vårt digitala testbatteri. Om ett motoriskt eller perceptuellt moment kräver fysisk närvaro kan vi arrangera ett kort besök i Stockholm.</p>
        <ul class="location-step__list">
  ...
  <div class="container">
    <div class="location-details__grid">
      <article class="location-info">
        <h3>Stöd för dig i Eskilstuna</h3>
        <p>Vi hjälper dig att omsätta diagnosen i konkreta verktyg för vardagen i Eskilstuna och Sörmland – helt digitalt men med lokalkännedom när du behöver kontakter eller intyg.</p>
        <ul class="location-info__list">
          <li>Mallar för arbetsgivare, elevhälsa, CSN, Försäkringskassan och privata försäkringar.</li>
          <li>Digitala fokusprogram och coachning anpassade för näringsliv, pendling mot Stockholm och familjeliv.</li>
      ...
      <article class="location-info">
        ...
        <ul class="location-info__list">
          ...
          <li>Fullständig rapport med diagnoskriterier, styrkor och rekommendationer som tar hänsyn till Eskilstunas arbetsliv och skolstruktur.</li>
...
<section class="location-cta location-cta--eskilstuna">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Skicka en kort beskrivning av din situation i Eskilstuna – vi matchar dig med rätt specialist och sätter upp tider samma dag.</p>
      <div class="hero-actions">
