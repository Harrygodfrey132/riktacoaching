---
title: "ADHD- och autismutredning i Norrköping"
draft: false
    ...
    <div class="location-details__grid">
      ...
      <article class="location-info">
        ...
        <ul class="location-info__list">
          ...
          <li>Fullständig rapport med diagnoskriterier, styrkor och rekommendationer som tar hänsyn till Norrköpings arbetsliv, universitetsstudier och skolstruktur.</li>
...
<section class="location-cta location-cta--norrkoping">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Skicka en kort beskrivning av din situation i Norrköping – vi matchar dig med rätt specialist och sätter upp tider samma dag.</p>
      <div class="hero-actions">
