---
title: "ADHD- och autismutredning i Vingåker"
draft: false
meta_title: "ADHD- och autismutredning i Vingåker | Rikta"
meta_keywords: "ADHD utredning Vingåker, autism privat Vingåker, psykiater Vingåker, neuropsykiatri Sörmland, Rikta Vingåker, Katrineholm"
meta_description: "ADHD- och autismutredning för Vingåker med digitalt upplägg, lokala somatiska prover hos partners och fysiska punktinsatser från vårt mobila team i Katrineholm."
og_title: "Neuropsykiatrisk utredning i Vingåker"
og_description: "Digital utredning med lokala prover i Vingåker och fysiska punktinsatser från vårt mobila team i Katrineholm vid behov."
---

<section class="location-hero location-hero--vingaker">
  <div class="container">
    <div class="location-hero__grid">
      <div class="location-hero__copy">
        ...
        <ul class="location-hero__highlights">
          ...
          <li>En process som fungerar för jobb, skola och vardag i Sörmland och Örebroregionen.</li>
...
<section class="location-journey">
  <div class="container">
    <header class="location-section__header">
      ...
      <h2>Din utredning i Vingåker, steg för steg</h2>
      <p>
        Upplägget är anpassat för dig som vill göra det mesta digitalt och samtidigt ha möjlighet till fysiska punktinsatser när det behövs.
        Så här brukar processen se ut när vi kombinerar digital utredning med lokala prover och mobila moment.
      </p>
    </header>
  ...
  <div class="container">
    <div class="location-details__grid">
      <article class="location-info">
        <h3>Stöd för dig i Vingåker</h3>
        <p>Vi hjälper dig att få struktur, förståelse och en plan som fungerar i vardagen – hemma, i skolan eller på jobbet.</p>
        <ul class="location-info__list">
          ...
          <li>Coachning som hjälper dig att bygga rutiner, energi och fokus över tid.</li>
...
<section class="location-cta location-cta--vingaker">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Berätta kort om din situation i Vingåker – vi matchar dig med rätt specialist och återkommer med tider samma dag.</p>
      <div class="hero-actions">
