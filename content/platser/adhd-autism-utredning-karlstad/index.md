---
title: "ADHD- och autismutredning i Karlstad"
draft: false
meta_title: "ADHD- och autismutredning i Karlstad | Rikta"
    ...
    <div class="location-hero__grid">
      <div class="location-hero__copy">
        ...
        <ul class="location-hero__highlights">
          ...
          <li>Samma team för medicin, coachning och arbetslivsstöd – med digital uppföljning.</li>
        </ul>
      ...
      <div class="location-hero__card">
        ...
        <dl class="location-hero__facts">
          ...
          <div>
            ...
            <dd>Videosamtal 07–21; provtagning i Karlstad centrum</dd>
          </div>
          <div>
            <dt>Eftervård</dt>
...
<section class="location-journey">
  <div class="container">
    <header class="location-section__header">
      ...
      <h2>Din utredning i Karlstad, steg för steg</h2>
      <p>
        Upplägget är byggt för dig som vill få klarhet utan att resa långt. Det mesta sker digitalt, och det som behöver göras fysiskt koordineras lokalt i Karlstad.
    ...
    <div class="location-details__grid">
      <article class="location-info">
        ...
        <ul class="location-info__list">
          ...
          <li>Samarbeten med företagshälsor och terapeuter när du behöver fler insatser.</li>
        </ul>
      </article>
      <article class="location-info">
        <h3>Vad som ingår</h3>
...
<section class="location-cta location-cta--karlstad">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Berätta kort om din situation i Karlstad – vi sätter ihop ett digitalt upplägg och återkommer med tider samma dag.</p>
      <div class="hero-actions">
