---
title: "ADHD- och autismutredning i Lund"
draft: false
meta_title: "ADHD- och autismutredning i Lund | Rikta"
    ...
    <div class="location-hero__grid">
      <div class="location-hero__copy">
        ...
        <p class="lead">
          ...
          Somatiska kontroller sker hos våra partners i Lund eller Malmö.
        </p>
        <ul class="location-hero__highlights">
          ...
          <li>Underlag och intyg för studenthälsa, CSN, arbetsgivare och Försäkringskassan.</li>
          <li>Digital uppföljning med samma team – även vid medicinering och coachning.</li>
        </ul>
      ...
      <div class="location-hero__card">
        ...
        <dl class="location-hero__facts">
          ...
          <div>
            ...
            <dd>Videosamtal 07–21; somatiska kontroller i Lund eller Malmö</dd>
          </div>
          <div>
            <dt>Eftervård</dt>
...
<section class="location-journey">
  <div class="container">
    <header class="location-section__header">
      ...
      <h2>Din utredning i Lund, steg för steg</h2>
      <p>
        Upplägget passar dig som vill hålla ihop studier, forskning eller arbetsliv – och ändå få en tydlig utredning och plan.
        Så här brukar processen se ut när vi gör det mesta digitalt och koordinerar somatiska kontroller lokalt.
      </p>
    </header>
  ...
  <div class="container">
    <div class="location-details__grid">
      <article class="location-info">
        <h3>Stöd för dig i Lund</h3>
        <p>Vi hjälper dig att få struktur och en plan som fungerar – i en vardag som ofta rör sig mellan studier, jobb och socialt liv.</p>
...
<section class="location-cta location-cta--lund">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Berätta kort om din situation i Lund – vi sätter ihop ett upplägg och återkommer med tider samma dag.</p>
      <div class="hero-actions">
