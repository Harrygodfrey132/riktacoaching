---
title: "ADHD- och autismutredning i Örebro"
draft: false
meta_title: "ADHD- och autismutredning i Örebro | Rikta"
meta_keywords: "ADHD utredning Örebro, autism privat Örebro, psykiater Örebro, neuropsykiatri Närke, Rikta Örebro"
meta_description: "Digitala ADHD- och autismutredningar för Örebro med specialistteam, videobesök och korta fysiska pass när det behövs."
og_title: "Neuropsykiatrisk utredning i Örebro"
og_description: "Komplett ADHD- och autismutredning med digitalt upplägg och punktinsatser nära Örebro."
---

<section class="location-hero location-hero--orebro">
  <div class="container">
    <div class="location-hero__grid">
      <div class="location-hero__copy">
        <span class="eyebrow">Örebro • Digitalt upplägg</span>
        <h1>ADHD- och autismutredning i Örebro</h1>
        <p class="lead">
          Vi hjälper invånare i Örebro och Närke att få en strukturerad utredning utan att pausa jobb eller studier.
        ...
        <ul class="location-hero__highlights">
          ...
          <li>Intyg och underlag anpassade för Örebros arbetsgivare, universitetsstudier, kommunala skolor och CSN.</li>
...
<section class="location-journey">
  <div class="container">
    <header class="location-section__header">
      ...
      <p>Upplägget anpassas för dig som bor i Örebro, studerar på universitetet, arbetar i regionen eller pendlar.
  ...
  <div class="container">
    <div class="location-details__grid">
      <article class="location-info">
        <h3>Stöd för dig i Örebro</h3>
        <p>Vi omsätter diagnosen i konkreta verktyg för vardagen i Örebro och Närke.</p>
      ...
      <article class="location-info">
        ...
        <ul class="location-info__list">
          ...
          <li>Fullständig rapport med diagnoskriterier, styrkor och rekommendationer som tar hänsyn till Örebros arbetsliv, universitetsstudier och skolstruktur.</li>
...
<section class="location-cta location-cta--orebro">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Skicka en kort beskrivning av din situation i Örebro – vi matchar dig med rätt specialist och sätter upp tider samma dag.</p>
      <div class="hero-actions">
