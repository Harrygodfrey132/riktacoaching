---
title: "ADHD- och autismutredning i Sundsvall"
draft: false
meta_title: "ADHD- och autismutredning i Sundsvall | Rikta"
meta_keywords: "ADHD utredning Sundsvall, autism privat Sundsvall, psykiater Sundsvall, neuropsykiatri Medelpad, Rikta Sundsvall"
meta_description: "Digitala ADHD- och autismutredningar för Sundsvall med specialistteam, videobesök och korta fysiska pass när det behövs."
og_title: "Neuropsykiatrisk utredning i Sundsvall"
og_description: "Komplett ADHD- och autismutredning med digitalt upplägg och punktinsatser nära Sundsvall."
---

<section class="location-hero location-hero--sundsvall">
  <div class="container">
    <div class="location-hero__grid">
      <div class="location-hero__copy">
        <span class="eyebrow">Sundsvall • Digitalt upplägg</span>
        <h1>ADHD- och autismutredning i Sundsvall</h1>
        <p class="lead">
          Vi hjälper dig i Sundsvall och Medelpad att få en strukturerad utredning som fungerar med ditt arbetsliv, studier eller familjesituation.
        ...
        <ul class="location-hero__highlights">
          ...
          <li>Intyg och underlag anpassade för Sundsvalls arbetsgivare, Mittuniversitetet, kommunala skolor och CSN.</li>
...
<section class="location-journey">
  <div class="container">
    <header class="location-section__header">
      ...
      <p>Upplägget anpassas för dig som bor i Sundsvall, studerar på Mittuniversitetet, arbetar i näringslivet eller balanserar familjeliv med karriär.
  ...
  <div class="container">
    <div class="location-details__grid">
      <article class="location-info">
        <h3>Stöd för dig i Sundsvall</h3>
        <p>Vi hjälper dig att omsätta diagnosen i konkreta verktyg för vardagen i Sundsvall och Medelpad – helt digitalt men med lokalkännedom när du behöver kontakter eller intyg.</p>
        <ul class="location-info__list">
          <li>Mallar för arbetsgivare, studenthälsa vid Mittuniversitetet, CSN, Försäkringskassan och privata försäkringar.</li>
      ...
      <article class="location-info">
        ...
        <ul class="location-info__list">
          ...
          <li>Fullständig rapport med diagnoskriterier, styrkor och rekommendationer som tar hänsyn till Sundsvalls arbetsliv, universitetsstudier och skolstruktur.</li>
...
<section class="location-cta location-cta--sundsvall">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Skicka en kort beskrivning av din situation i Sundsvall – vi matchar dig med rätt specialist och sätter upp tider samma dag.</p>
      <div class="hero-actions">
