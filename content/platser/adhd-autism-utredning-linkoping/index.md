---
title: "ADHD- och autismutredning i Linköping"
draft: false
meta_title: "ADHD- och autismutredning i Linköping | Rikta"
meta_keywords: "ADHD utredning Linköping, autism privat Linköping, psykiater Linköping, neuropsykiatri Östergötland, Rikta Linköping"
meta_description: "Digitala ADHD- och autismutredningar för Linköping med specialistteam, videobesök och korta fysiska pass när det behövs."
og_title: "Neuropsykiatrisk utredning i Linköping"
og_description: "Komplett ADHD- och autismutredning med digitalt upplägg och punktinsatser nära Linköping."
---

<section class="location-hero location-hero--linkoping">
  <div class="container">
    <div class="location-hero__grid">
      <div class="location-hero__copy">
        <span class="eyebrow">Linköping • Digitalt upplägg</span>
        <h1>ADHD- och autismutredning i Linköping</h1>
        <p class="lead">
          Vi hjälper invånare i Linköping och Östergötland att få en strukturerad utredning utan att pausa jobb eller studier.
        ...
        <ul class="location-hero__highlights">
          ...
          <li>Intyg och underlag anpassade för Linköpings arbetsgivare, universitetsstudier, kommunala skolor och CSN.</li>
...
<section class="location-journey">
  <div class="container">
    <header class="location-section__header">
      ...
      <p>Upplägget anpassas för dig som bor i Linköping, studerar på universitetet, arbetar inom teknik eller industri, eller pendlar i regionen.
  ...
  <div class="container">
    <div class="location-details__grid">
      <article class="location-info">
        <h3>Stöd för dig i Linköping</h3>
        <p>Vi omsätter diagnosen i konkreta verktyg för vardagen i Linköping och Östergötland.</p>
        <ul class="location-info__list">
          <li>Mallar för arbetsgivare, studenthälsa, CSN, Försäkringskassan och reseintyg.</li>
          <li>Digitala fokusprogram och coachning för studier, pendling och arbetsliv.</li>
          <li>Samarbeten med närliggande företagshälsor och terapeuter när fler insatser behövs.</li>
        </ul>
      </article>
      <article class="location-info">
        <h3>Vad som ingår</h3>
        <ul class="location-info__list">
          ...
          <li>Fullständig rapport med diagnoskriterier, styrkor och rekommendationer som tar hänsyn till Linköpings arbetsliv, universitetsstudier och skolstruktur.</li>
...
<section class="location-cta location-cta--linkoping">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Skicka en kort beskrivning av din situation i Linköping – vi matchar dig med rätt specialist och sätter upp tider samma dag.</p>
      <div class="hero-actions">
