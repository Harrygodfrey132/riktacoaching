...
<section class="location-hero location-hero--stockholm">
  <div class="container">
      ...
      <div class="location-hero__card">
        ...
        <dl class="location-hero__facts">
          ...
          <div>
            ...
            <dd>Videosamtal 07–21; korta Stockholmsbesök när ett specifikt test kräver det</dd>
          </div>
          <div>
            <dt>Eftervård</dt>
...
<section class="location-journey">
  <div class="container">
    <header class="location-section__header">
      ...
      <p>Varje utredning anpassas efter dina kontaktpunkter i Stockholm – kanske pendlar du mellan kontor, studerar på distans eller behöver förklara din funktionsprofil för HR.
        Så här brukar upplägget se ut när allt sker digitalt med möjlighet till punktinsatser på plats.</p>
    </header>
  ...
  <div class="container">
    <div class="location-details__grid">
      <article class="location-info">
        <h3>Stöd för dig i Stockholm</h3>
        <p>Vi hjälper dig att omsätta diagnosen i konkreta verktyg för livet i Stockholm – helt digitalt men med lokalkännedom när du behöver kontakter eller intyg.</p>
        <ul class="location-info__list">
          <li>Färdiga mallar för HR, studenthälsa, CSN, SL-intyg, Försäkringskassan och privata försäkringar.</li>
