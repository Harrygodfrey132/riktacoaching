---
title: "ADHD- och autismutredning i Katrineholm"
draft: false
  ...
  <div class="container">
    <div class="location-details__grid">
      <article class="location-info">
        <h3>Stöd för dig i Katrineholm</h3>
        <p>Vi omsätter diagnosen i konkreta verktyg för vardagen i Katrineholm och Sörmland.</p>
        <ul class="location-info__list">
          <li>Mallar för arbetsgivare, elevhälsa, CSN, Försäkringskassan och reseintyg.</li>
          <li>Digitala fokusprogram och coachning för skiftarbete, pendling och familjeliv.</li>
      ...
      <article class="location-info">
        ...
        <ul class="location-info__list">
          ...
          <li>Fullständig rapport med diagnoskriterier, styrkor och rekommendationer som tar hänsyn till Sörmlands arbetsliv och skolstruktur.</li>
...
<section class="location-cta location-cta--katrineholm">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Skicka en kort beskrivning av din situation i Katrineholm – vi matchar dig med rätt specialist och sätter upp tider samma dag.</p>
      <div class="hero-actions">
