---
title: "ADHD- och autismutredning i Gävle"
draft: false
meta_title: "ADHD- och autismutredning i Gävle | Rikta"
meta_keywords: "ADHD utredning Gävle, autism privat Gävle, psykiater Gävle, neuropsykiatri Gästrikland, Rikta Gävle"
meta_description: "Digitala ADHD- och autismutredningar för Gävle med specialistteam, videobesök och korta fysiska pass när det behövs."
og_title: "Neuropsykiatrisk utredning i Gävle"
og_description: "Komplett ADHD- och autismutredning med digitalt upplägg och punktinsatser nära Gävle."
---

<section class="location-hero location-hero--gavle">
  <div class="container">
    <div class="location-hero__grid">
      <div class="location-hero__copy">
        <span class="eyebrow">Gävle • Digitalt upplägg</span>
        <h1>ADHD- och autismutredning i Gävle</h1>
        <p class="lead">
          Vi hjälper dig i Gävle och Gästrikland att få en strukturerad utredning som fungerar med ditt arbetsliv, studier eller familjesituation.
        ...
        <ul class="location-hero__highlights">
          ...
          <li>Intyg och underlag anpassade för Gävles arbetsgivare, Högskolan i Gävle, kommunala skolor och CSN.</li>
...
<section class="location-journey">
  <div class="container">
    <header class="location-section__header">
      ...
      <p>Upplägget anpassas för dig som bor i Gävle, studerar på Högskolan i Gävle, arbetar i näringslivet eller balanserar familjeliv med karriär.
  ...
  <div class="container">
    <div class="location-details__grid">
      <article class="location-info">
        <h3>Stöd för dig i Gävle</h3>
        <p>Vi hjälper dig att omsätta diagnosen i konkreta verktyg för vardagen i Gävle och Gästrikland – helt digitalt men med lokalkännedom när du behöver kontakter eller intyg.</p>
        <ul class="location-info__list">
          <li>Mallar för arbetsgivare, studenthälsa vid Högskolan i Gävle, CSN, Försäkringskassan och privata försäkringar.</li>
      ...
      <article class="location-info">
        ...
        <ul class="location-info__list">
          ...
          <li>Fullständig rapport med diagnoskriterier, styrkor och rekommendationer som tar hänsyn till Gävles arbetsliv, högskolestudier och skolstruktur.</li>
...
<section class="location-cta location-cta--gavle">
  <div class="container">
    <div class="location-cta__content">
      <h2>Redo att få klarhet?</h2>
      <p>Skicka en kort beskrivning av din situation i Gävle – vi matchar dig med rätt specialist och sätter upp tider samma dag.</p>
      <div class="hero-actions">
