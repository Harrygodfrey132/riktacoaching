    ...
    <div class="clinician-grid clinician-grid--feature">
      ...
      <article class="clinician-card">
        ...
        <div class="clinician-card__body">
          ...
          <div class="clinician-card__links">
            <a class="clinician-card__link" href="https://riktacoaching.kaddio.com/booking/cal?step=pickBookingType">Book Now</a>
            <a class="clinician-card__link" href="/about-us/jonny-baker/">Learn more</a>
          </div>
        </div>
      </article>
      ...
      <article class="clinician-card">
        ...
        <div class="clinician-card__body">
          ...
          <div class="clinician-card__links">
            <a class="clinician-card__link" href="https://riktacoaching.kaddio.com/booking/cal?step=pickBookingType">Book Now</a>
            <a class="clinician-card__link" href="/about-us/alice-stern/">Learn more</a>
          </div>
        </div>
      </article>
      ...
      <article class="clinician-card">
        ...
        <div class="clinician-card__body">
          ...
          <div class="clinician-card__links">
            <a class="clinician-card__link" href="https://riktacoaching.kaddio.com/booking/cal?step=pickBookingType">Book Now</a>
            <a class="clinician-card__link" href="/about-us/harley-murray/">Learn more</a>
          </div>
        </div>
      </article>
    </div>
  ...
  <div class="container">
    ...
    <div class="value-grid">
      ...
      <article class="value-card animate-up">
        <span class="value-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" role="presentation">
            <path d="M12 21s-6-4.35-6-10a6 6 0 1112 0c0 5.65-6 10-6 10z" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </span>
        <h3>Warmth</h3>
        <p>We meet you with empathy and adapt to your pace.</p>
      </article>
      <article class="value-card animate-up">
        <span class="value-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" role="presentation">
            <path d="M12 3l7 4v6c0 4-3 7-7 8-4-1-7-4-7-8V7l7-4z" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </span>
        <h3>Safety</h3>
