  ...
  <div class="container">
      ...
      <div class="legal-hero__inner">
        ...
        <div class="legal-hero__card">
          ...
          <ul class="legal-checklist">
            <li>Vi använder dina uppgifter enbart för bedömning och uppföljning.</li>
            <li>Hälsodata lagras krypterat i journalsystemet Kaddio.</li>
            <li>Notifieringar innehåller aldrig dina testresultat.</li>
          </ul>
    ...
    <div class="legal-grid">
      <article class="legal-card">
        ...
        <p><strong>Rikta Psykiatri</strong> är en registrerad vårdgivare hos <strong>IVO (Inspektionen för vård och omsorg)</strong>. Ansvarig för dina uppgifter är vår verksamhetschef Philip Lindersten.</p>
      </article>
